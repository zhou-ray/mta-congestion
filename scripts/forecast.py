...
OUTPUT_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'visualizations')


def build_lag_lookup() -> pd.DataFrame:
    json_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'lag_lookup.json')
